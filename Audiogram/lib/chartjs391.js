...
!function(t, e) {
    ...
    function gt(t, e, i) {
        ...
        if (t._sorted) {
            ...
            o = u ? Z(Math.max(et(r, a.axis, c, !0).hi + 1, i ? 0 : et(e, l, a.getPixelForValue(c), !0).hi + 1), n, s) - n : s - n
        }
        return {
            start: n,
            count: o
 ...
 */
    ...
    function je(t, e, i, o) {
        ...
        return null !== c && ((!M(r) || r === i || (c = He(h, l, r, c, o),
        null !== c)) && Ee(Array.from(h), [""], a, r, (()=>function(t, e, i) {
    ...
    function Ze(t, e="x") {
        ...
        !function(t, e, i) {
            ...
            for (let c = 0; c < s - 1; ++c)
                l = h,
                h = qe(t, c + 1),
                l && h && (N(e[c], 0, Xe) ? i[c] = i[c + 1] = 0 : (n = i[c] / e[c],
                o = i[c + 1] / e[c],
    ...
    function Qe(t, e, i, s, n) {
        ...
        e.capBezierPoints && function(t, e) {
            ...
            s = t.length; i < s; ++i)
                ...
                r = i < s - 1 && Se(t[i + 1], e),
                o && (n = t[i],
                a && (n.cp1x = Je(n.cp1x, e.left, e.right),
                n.cp1y = Je(n.cp1y, e.top, e.bottom)),
                r && (n.cp2x = Je(n.cp2x, e.left, e.right),
    ...
    function mi(t, e) {
        ...
        s && !("" + s).match(ci) && (console.warn('Invalid font style specified: "' + s + '"'),
        s = "");
        const n = {
    ...
    function bi(t, e, i, n) {
        ...
        a = t.length; o < a; ++o)
            ...
            l = !1),
            void 0 !== i && s(r) && (r = r[i % r.length],
            l = !1),
            void 0 !== r))
                return n && !l && (n.cacheable = !1),
                r
    }
    function xi(t, e, i) {
        const {min: s, max: n} = t
    ...
    function os(t, e, i) {
        const s = t.canvas
          , n = new MutationObserver((t=>{
            let e = !1;
            for (const i of t)
                e = e || ns(i.addedNodes, s),
                e = e && !ns(i.removedNodes, s);
            e && i()
        }
        ));
    ...
    class ys {
        ...
        _createAnimations(t, e) {
            ...
            for (r = o.length - 1; r >= 0; --r) {
                ...
                d && d.duration ? (n[l] = c = new xs(d,t,l,h),
                s.push(c)) : t[l] = h
            }
            return s
        }
        update(t, e) {
            ...
            return i.length ? (mt.add(this._chart, i),
            !0) : void 0
        }
    }
    function vs(t, e) {
    ...
    class Ls {
        ...
        updateIndex(t) {
            this.index !== t && Cs(this._cachedMeta),
            this.index = t
        }
        linkScales() {
            const t = this.chart
        ...
        updateRangeFromParsed(t, e, i, s) {
            ...
            s && a && (s.values = a,
            o = Ms(s, n, this._cachedMeta.index)),
        ...
        getMinMax(t, e) {
            ...
            for (u = 0; u < a && (g() || (this.updateRangeFromParsed(h, t, f, l),
            !n)); ++u)
                ;
            if (n)
                for (u = a - 1; u >= 0; --u)
    ...
    function zs(t, e) {
        ...
        if (a > 0) {
            ...
            for (Fs(e, h, c, i(n) ? 0 : r - n, r),
            t = 0,
            s = a - 1; t < s; t++)
                Fs(e, h, c, o[t], o[t + 1]);
            return Fs(e, h, c, l, i(n) ? e.length : l + n),
            h
        }
        return Fs(e, h, c),
        h
    ...
    class $s extends Es {
        ...
        update(t, e, i) {
            ...
            o.display && (o.autoSkip || "auto" === o.source) && (this.ticks = zs(this, this.ticks),
            this._labelSizes = null,
            this.afterAutoSkip()),
        ...
        generateTickLabels(t) {
            ...
            s = t.length; i < s; i++)
                n = t[i],
                n.label = c(e.callback, [n.value, i, t], this)
        }
        ...
        fit() {
            ...
            if (o) {
                ...
                t.height = Ws(n) + o) : (t.height = this.maxHeight,
                t.width = Ws(n) + o),
            ...
            for (l = 0; l < e; ++l) {
                ...
                i(u) || s(u)) {
                    if (s(u))
                        ...
                        c = u.length; h < c; ++h)
                            _ = u[h],
                            i(_) || s(_) || (b = _e(n, p.data, p.gc, b, _),
                            x += m)
                } else
                    b = _e(n, p.data, p.gc, b, u),
                    x = m;
                a.push(b),
                r.push(x),
                y = Math.max(b, y),
        ...
        _computeLabelItems(t) {
            ...
            _ = l.length; x < _; ++x) {
                ...
                C = "top" === o ? "near" === c || 0 !== m ? -O * D + D / 2 : "center" === c ? -T.highest.height / 2 - e * D + D : -T.highest.height + D / 2 : "near" === c || 0 !== m ? D / 2 : "center" === c ? T.highest.height / 2 - e * D : T.highest.height - O * D,
                u && (C *= -1)) : (M = S,
                C = (1 - O) * D / 2),
                t.showLabelBackdrop) {
        ...
        drawBorder() {
            ...
            const o = i.setContext(this.getContext(0)).lineWidth
              , a = this._borderValue;
            let r, l, h, c;
            this.isHorizontal() ? (r = ve(t, this.left, n) - n / 2,
            l = ve(t, this.right, o) + o / 2,
            h = c = a) : (h = ve(t, this.top, n) - n / 2,
        ...
        drawTitle() {
            ...
            "bottom" === e || "center" === e || n(e) ? (h += r.bottom,
            s(i.text) && (h += a.lineHeight * (i.text.length - 1))) : h += r.top;
    ...
    class Ys {
        ...
        unregister(t) {
            const e = this.items
              ...
              , s = this.scope;
            i in e && delete e[i],
            s && i in ne[s] && (delete ne[s][i],
            this.override && delete te[i])
        }
    }
    var Us = new class {
        constructor() {
    ...
    class Xs {
        ...
        _notify(t, e, i, s) {
            ...
            for (const n of t) {
                const t = n.plugin;
                if (!1 === c(t[i], [e, s, n.options], t) && s.cancelable)
                    return !1
            }
            return !0
        }
        invalidate() {
            i(this._cache) || (this._oldCache = this._cache,
            this._cache = void 0)
        }
        _descriptors(t) {
            if (this._cache)
    ...
    class on {
        ...
        datasetAnimationScopeKeys(t, e) {
            return sn(`${t}.transition.${e}`, (()=>[[`datasets.${t}.transitions.${e}`, `transitions.${e}`], [`datasets.${t}`, ""]]))
        }
    ...
    class bn {
        constructor(t, i) {
            ...
            this._dataChanges = [],
            gn[this.id] = this,
            r && l ? (mt.listen(this, "complete", dn),
        ...
        clear() {
            return we(this.canvas, this.ctx),
            this
        }
        stop() {
            return mt.stop(this),
        ...
        _resize(t, e) {
            ...
            this._aspectRatio = this.aspectRatio,
            pe(this, a, !0) && (this.notifyPlugins("resize", {
                size: o
            }),
        ...
        buildOrUpdateScales() {
            ...
            d(n, (e=>{
                const n = e.options
                  ...
                  , a = Zs(o, n)
                  , l = r(n.type, e.dtype);
                void 0 !== n.position && hn(n.position, a) === hn(e.dposition) || (n.position = e.dposition),
                s[o] = !0;
                let h = null;
                if (o in i && i[o].type === l)
                    h = i[o];
                else {
                    h = new (Us.getScale(l))({
                        id: o,
        ...
        _checkEventBindings() {
            const t = this.options
              ...
              , i = new Set(t.events);
            S(e, i) && !!this._responsiveListeners === t.responsive || (this.unbindEvents(),
            this.bindEvents())
        }
        ...
        render() {
            !1 !== this.notifyPlugins("beforeRender", {
                cancelable: !0
            }) && (mt.has(this) ? this.attached && !mt.running(this) && mt.start(this) : (this.draw(),
            dn({
                chart: this
            })))
        }
    ...
    function Mn(t) {
        ...
        const l = ()=>{
            32767 !== o && -32768 !== o && (M(a) && (r = Math.min(r, Math.abs(o - a) || r)),
            a = o)
        }
        ;
        for (s = 0,
    ...
    function Dn(t, e, i, s) {
        ...
        (i._top || 0) === s ? n = h : (i._bottom || 0) === s ? n = c : (o[On(c, a, r, l)] = !0,
        n = h)),
        o[On(n, a, r, l)] = !0,
        t.borderSkipped = o
    }
    function On(t, e, i, s) {
        var n, o, a;
        return s ? (a = i,
        t = Cn(t = (n = t) === (o = e) ? a : n === a ? o : n, i, e)) : t = Cn(t, e, i),
        t
    }
    function Cn(t, e, i) {
    ...
    class Tn extends Ls {
        ...
        _calculateBarValuePixels(t) {
            ...
            if (c = this.chart.getDataVisibility(t) ? e.getPixelForValue(f + g) : m,
            d = c - m,
            Math.abs(d) < o) {
                d = function(t, e, i) {
            ...
            if (e.grouped) {
                const s = o ? this._getStackCount(t) : e.stackCount
                  , r = "flex" === n.barThickness ? function(t, e, i, s) {
                    ...
                    let a, r;
                    return i(o) ? (a = e.min * s.categoryPercentage,
                    r = s.barPercentage) : (a = o * n,
                    r = 1),
                    {
                        chunk: a / n,
                        ratio: r,
    ...
    function Nn(t, e, i) {
        ...
        t.arc(o, a, r, s - h, i + h),
        l > n ? (h = n / l,
        t.arc(o, a, l, i + h, s - h, !0)) : t.arc(o, a, n, i + L, s - L),
        t.closePath(),
        t.clip()
    }
    function Wn(t, e, i, s) {
    ...
    class io extends Es {
        ...
        draw(t, e) {
            const i = this.options;
            this.skip || i.radius < .1 || !Se(this, e, this.size(i) / 2) || (t.strokeStyle = i.borderColor,
    ...
    var go = {
        ...
        beforeElementsUpdate: (t,e,s)=>{
            ...
            t.data.datasets.forEach(((e,o)=>{
                ...
                if (u <= (s.threshold || 4 * n))
                    return void uo(e);
                let f;
                switch (i(a) && (e._data = h,
                delete e.data,
        ...
        const a = function(t) {
            if ((t.scale || {}).getPointPositionForValue)
                return function(t) {
                    const {scale: e, fill: i} = t
                      ...
                      , r = function(t, e, i) {
                        let s;
                        return s = "start" === t ? i : "end" === t ? e.options.reverse ? e.min : e.max : n(t) ? t.value : e.getBaseValue(),
                        s
                    }(i, e, a)
                      , l = [];
                    if (s.grid.circular) {
            ...
            return function(t) {
                const {scale: e={}, fill: i} = t
                  , s = function(t, e) {
                    let i = null;
                    return "start" === t ? i = e.bottom : "end" === t ? i = e.top : n(t) ? i = e.getPixelForValue(t.value) : e.getBasePixel && (i = e.getBasePixel()),
                    i
                }(i, e);
                if (o(s)) {
    ...
    var To = {
        ...
        afterDatasetsUpdate(t, e, i) {
            ...
            for (a = 0; a < s; ++a)
                l = n[a],
                l && !1 !== l.fill && (l.fill = yo(n, a, i.propagate))
        },
        beforeDraw(t, e, i) {
    ...
    class Eo extends Es {
        ...
        _draw() {
            ...
            this.legendItems.forEach(((v,w)=>{
                s.strokeStyle = v.fontColor || c,
                s.fillStyle = v.fontColor || c;
                ...
                x ? w > 0 && P + S + d > this.right && (D = g.y += y,
                g.line++,
                P = g.x = ut(n, this.left + d, this.right - i[g.line])) : w > 0 && D + y > this.bottom && (P = g.x = P + e[g.line].width + d,
                g.line++,
                ...
                !function(t, e, i) {
                    ...
                    if (s.fillStyle = r(i.fillStyle, a),
                    ...
                    o.usePointStyle) {
                        ...
                        const o = e + Math.max((u - m) / 2, 0)
                          ...
                          , r = gi(i.borderRadius);
                        s.beginPath(),
                        Object.values(r).some((t=>0 !== t)) ? Le(s, {
                            x: a,
                            y: o,
                            w: p,
                            h: m,
    ...
    class Io extends Es {
        ...
        _drawArgs(t) {
            const {top: e, left: i, bottom: s, right: n, options: o} = this
              , a = o.align;
            let r, l, h, c = 0;
            return this.isHorizontal() ? (l = ut(a, i, n),
            h = e + t,
    ...
    function No(t, e) {
        return e && (s(e) ? Array.prototype.push.apply(t, e) : t.push(e)),
        t
    }
    function Wo(t) {
    ...
    class Go extends Es {
        ...
        drawTitle(t, e, i) {
            ...
            if (n) {
                ...
                for (t.x = Xo(this, i.titleAlign, i),
        ...
        drawFooter(t, e, i) {
            ...
            if (n) {
                ...
                for (t.x = Xo(this, i.footerAlign, i),
    ...
    class ia extends $s {
        ...
        buildTicks() {
            ...
            const n = function(t, e) {
                ...
                i(l) || (v = Math.pow(10, l),
                S = Math.ceil(S * v) / v),
                "ticks" === n ? (w = Math.floor(p / S) * S,
                M = Math.ceil(m / S) * S) : (w = p,
                M = m),
                b && x && o && W((r - a) / o, S / 1e3) ? (k = Math.round(Math.min((r - a) / S, c)),
                S = (r - a) / k,
                w = a,
                M = r) : _ ? (w = b ? a : w,
                M = x ? r : M,
                ...
                w < a && D++,
                N(Math.round((w + D * S) * v) / v, a, ea(a, y, t)) && D++) : w < a && D++); D < k; ++D)
                    s.push({
    ...
    class oa extends $s {
        ...
        getPixelForValue(t) {
            ...
            null === t || isNaN(t) ? NaN : this.getPixelForDecimal(t === this.min ? 0 : (I(t) - this._startValue) / this._valueRange)
        }
        getValueForPixel(t) {
                ...
                for (let o = e - 1; o >= 0; o--) {
                    ...
                    if (!i(g)) {
                        ...
                        const n = c - i.left
                          ...
                          , a = u - c + i.width
                          , r = f - d + i.height;
                        Object.values(t).some((t=>0 !== t)) ? (s.beginPath(),
                        Le(s, {
                            x: n,
                            y: o,
                            w: a,
    ...
    function xa(t, e) {
        ...
        null === l ? null : (a && (l = "week" !== a || !B(r) && !0 !== r ? s.startOf(l, a) : s.startOf(l, "isoWeek", r)),
        +l)
    }
    function _a(t, e, i, s) {
        const n = ma.length;
    ...
    function Ma(t, e, i) {
        ...
        i ? (e >= t[r].pos && e <= t[l].pos && ({lo: r, hi: l} = et(t, "pos", e)),
        ({pos: s, time: o} = t[r]),
        ({pos: n, time: a} = t[l])) : (e >= t[r].time && e <= t[l].time && ({lo: r, hi: l} = et(t, "time", e)),
        ({time: s, pos: o} = t[r]),
        ({time: n, pos: a} = t[l]));
        const h = n - s;
