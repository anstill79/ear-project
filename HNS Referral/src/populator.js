...
let newDataObj = {
  ...
  "ABG > 30dB absent reflexes": {
    Guidance: "Offer HNS referral for surgery, or HA if not interested.",
  },
  "Conductive Component with Present Reflexes": {
    Guidance: "VEMP. If positive, refer to HNS. If negative, HA",
  },
};
...
export function populateSecondarySelects() {
  ...
  timing_result_wrapper.style.opacity = "0.5";
  age_result.innerHTML = "";
  age_result_wrapper.style.opacity = "0.5";
  if (secondary.Timing) {
